...
import { Download, Email, Facebook, Share, Telegram, WhatsApp } from "@mui/icons-material";
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden  bg-white p-2 text-left align-middle shadow-xl transition-all">
                  <div className="mt-2">
                    <div className="grid grid-cols-6 gap-6 m-auto h-fit p-4 ">
                      <MenuItem title="Facebook" className="bg-blue-400">
                        <Facebook />
                      </MenuItem>
                      <MenuItem title="WhatsApp" className="bg-green-400">
                        <WhatsApp />
                      </MenuItem>
                      <MenuItem title="Telegram" className="bg-sky-400">
                        <Telegram />
                      </MenuItem>
                      <MenuItem title="Email" className="bg-amber-400">
                        <Email />
                      </MenuItem>
