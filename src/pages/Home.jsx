  ...
  return (
    <header className="h-fit bg-white p-4 pb-8">
      ...
      <div className="shadow rounded-xl mt-3">
        <div className="py-2 px-4 bg-sky-500 rounded-t-xl  text-white text-md">
          <h2 className="font-bold ">Entering Public Place ? </h2>
          <h3 className="text-sm">Stay alert to stay safe</h3>
        </div>
        <div className="py-2 px-4 flex text-black items-center justify-between">
          <div className="w-2/3 flex items-center text-sm">
            <ChevronDownIcon className="w-6" />
            <span className="text-sm ml-2">Check-in Preferences</span>
          </div>
    ...
    <section className="grid grid-cols-4 gap-6 m-auto h-fit p-4 ">
      ...
      <Link to="/ibu-anak">
        <MenuItem title="Peduli Ibu Anak" className="bg-sky-600 animate-pulse">
          <div className="w-sm">
            <svg width="48" viewBox="0 0 275 309" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
...
const FAB = () => {
  return (
    <div className="fixed bottom-10 right-5 bg-white rounded-full p-3 shadow text-blue-400">
      <QuestionMarkCircleIcon fontSize="large"></QuestionMarkCircleIcon>
    </div>
  );
};
