              ...
              <li className="relative mb-6 sm:mb-0">
                ...
                <div className="mt-3 sm:pr-8 -ml-[20%]">
                  <span className="block mb-2 font-normal leading-none text-gray-400 dark:text-gray-500">
                    {showFormattedDate(pregnancyData[0]?.estimasi_tanggal_kelahiran).split(",")[1]}
                  </span>
                </div>
              </li>
            </ol>
        ...
        <div className="flex m-auto">
          <ul className="space-y-3 m-auto">
            {checkupListData.map((checkup) => (
              <li key={checkup.id} className="p-6 space-y-2 border rounded-lg dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="flex space-x-2 items-center text-sm">
                  ...
                  <span>
                    {checkup.pemeriksa.jabatan.toLowerCase().includes("dokter") ? "dr. " : ""}
